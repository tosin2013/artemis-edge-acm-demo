...
info = {
    ...
    "openshift_cluster_admin_password": data.get("openshift_kubeadmin_password", ""),
...
kubeconfig_matches = _glob.glob(os.path.join(output_dir, f"*_{info['guid']}_kubeconfig"))
if kubeconfig_matches:
    info["kubeconfig_path"] = kubeconfig_matches[0]
